...
| :---: | :---: |
| *Secure login for all staff members, managed by the `LoginForm`. ![Login Screen](https://imgur.com/guBiAl0) [img]https://i.imgur.com/Hb4CFG7.png[/img] * | *A central hub for doctors, displaying key analytics and system information from `FormDashboard`. ![Dashboard Screen](https://imgur.com/u4x7EhQ)* |
|  |  |
