...
public class MenuItem extends JPanel {
    ...
    private Icon getIcon() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon("com/globemed/menu/icon/" + menuName + ".svg");
            ...
            if (i == 0) {
                ...
                menuItem.addActionListener((ActionEvent e) -> {
                    if (menus.length > 1) {
                        ...
                        menu.runEvent(menuName, 0);
                    }
                });
            } else {
                final int subIndex = i;
                menuItem.addActionListener((ActionEvent e) -> {
                    // Use menuName instead of menuIndex
                    menu.runEvent(menuName, subIndex);
                });
            }
            add(menuItem);
        }
        popup = new PopupSubmenu(getComponentOrientation(), menu, menuName, menus);
    }
